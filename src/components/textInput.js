...
export default function AppTextInput(props) {
        ...
        return (
            <View style={{ width: '100%', marginBottom: 20 }}>
                ...
                <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderRadius: 8, paddingRight: 10, backgroundColor: Colors.seconday, }}>
                    <TextInput placeholderTextColor={'grey'} {...props} style={[styles.input, { width: '90%' }, props.style]} />
                    {props.rightElement}
                </View>
            </View>
        );
    ...
    if (props?.type == 'password') {
        return (
            <View style={{ width: '100%', marginBottom: 20 }}>
                <AppText style={{ color: Colors.primary, marginBottom: 2 }}>{props.label}</AppText>
                <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderRadius: 8, paddingRight: 10, backgroundColor: Colors.seconday, }}>
                    <TextInput secureTextEntry={isSecure} placeholderTextColor={'grey'} {...props} style={[styles.input, { width: '90%' }, props.style]} />
    ...
    return (
        <View style={{ width: '100%', marginBottom: 20 }}>
            <AppText style={{ color: Colors.primary, marginBottom: 2 }}>{props.label}</AppText>
            <TextInput placeholderTextColor={'grey'} {...props} style={[styles.input, props.style]} />
        </View>
    );
}
