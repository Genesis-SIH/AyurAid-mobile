...
export function RoundButton(props) {
    ...
    return (
        <TouchableOpacity onPress={props.onPress} {...props} style={[buttonType,commonButtonStyle,{ borderRadius: 50, padding: 10, alignItems: "center", justifyContent: "center",width:'100%' }, props.style]}>
...
export function FlatButton(props) {
    ...
    return (
        <TouchableOpacity onPress={props.onPress}  {...props} style={[buttonType,commonButtonStyle,{ borderRadius: 8,}, props.style]}>
            <AppText bold={props.boldTitle} style={{ color: props.outline ? Colors.primary : "white",fontSize:18 }}>{props.title}</AppText>
        </TouchableOpacity>
    )
}
