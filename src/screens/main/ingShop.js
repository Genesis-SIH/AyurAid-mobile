      ...
      links: [
        {
          ...
          image:
            "https://images-na.ssl-images-amazon.com/images/I/51QXU%2Bq%2B2RL._SL1000_.jpg",
        ...
        },
        {
          ...
          image:
            "https://rukminim1.flixcart.com/image/416/416/k0vbgy80pkrrdj/fruit-dry-fruit-nut/p/8/4/1-gokhru-gokshura-powder-100-pure-organic-herbal-powder-100gm-original-imafk5zgjzgjgq2h.jpeg?q=70",
        ...
        },
        {
          ...
          image:
            "https://www.bigbasket.com/media/uploads/banner_images/2006_ayurveda_380.jpg",
        ...
        <View key={item.id} style={styles.card}>
          ...
          <ScrollView horizontal style={{ marginTop: 20 }}>
            {item.links.map((linkRef, index) => (
              <TouchableOpacity
                key={item.id + "#" + linkRef.id}
                onPress={() => Linking.openURL(linkRef.url)}
                style={{
                  width: 100,
                  height: 100,
                  borderRadius: 10,
              ...
              >
                ...
                >
                  ...
                  <AppText style={{ marginLeft: 12, fontSize: 14 }}>
                    {linkRef.name}
                  </AppText>
                </LinearGradient>
              </TouchableOpacity>
